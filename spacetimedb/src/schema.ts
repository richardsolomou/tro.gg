 ...
 * is reserved for carryables with visual variants. `style` is the chosen
...
const player = table(
  { name: "player", public: true },
  {
    ...
    // kind of the held entity. The legacy "boulder" value remains supported so
    // old rows can still put down or throw what they hold.
    ...
    // Visual variant for future carried entities that need one.
 ...
 * sanctioned scheduled-reducer exception: re-armed only while a
 ...
 * re-arms only while a player is online, writes only
