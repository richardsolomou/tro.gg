...
- **Daylight and scale.** The continent lives under a **sun**: a sky backdrop with aerial haze, a bright warm directional sun (riding the camera focus with its shadow box) and a cool sky bounce — a world, not a cave. Rock formations vary from shoulder-height outcrops to **towering crags** (deterministic per-tile heights, 1.4–3.4 tiles), so the low camera angles read at landscape scale and the sun rakes long shadows off them.
