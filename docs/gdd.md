...
- The current world ships a single shared zone *(working slug `hog-town`, a procedurally generated 64×44 cave (initial))*; additional zones, starting areas, and gates can be added when they help the current gameplay.
