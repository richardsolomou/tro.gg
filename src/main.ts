...
import { captureEvent, captureException, captureLog, identifyUser, initAnalytics, isFeatureEnabled } from "./analytics.js";
...
async function main() {
  ...
  try {
    ...
    captureLog("info", "Player joined world", { zone: STARTING_ZONE_SLUG, is_guest: !signedIn });
    ...
    captureException(err, { surface: "startup" });
    captureLog("fatal", "Game startup failed", { surface: "startup" });
  }
}
