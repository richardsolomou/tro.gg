...
const STATES = [
  ...
  { name: "ridge trogg running", query: "creature=trogg:ridge&item=none&mode=run&paused=1&scrub=0.4" },
  { name: "stone trogg downed", query: "creature=trogg:stone&item=none&mode=dead&paused=1" },
