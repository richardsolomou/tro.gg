...
/**
 * Per-zone entity ceilings (GDD "Data model"). The server enforces these caps so a
 * scripted client cannot flood shared zone state. (initial)
 */
...
/** Trogg combat health and respawn timing. (initial) */
 ...
 * (a sanctioned timer exception). Dead troggs never regen.
 * (initial)
 */
...
/** One entry in a world-object loot table. */
 ...
 * Tools resolve their gathering target first (pickaxe → boulder,
...
/** Walkable AND dry: where things may be placed. */
