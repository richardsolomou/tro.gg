...
test("path motion never rewinds onto a blocked tile it has already crossed", () => {
  // An obstacle appears on (2,1) — a tile the trogg already walked over — after the route
...
test("a creature's walkable headings treat an occupied tile like a wall", () => {
...
// --- Large footprints: a size-2 mover clamps across its whole footprint ---
